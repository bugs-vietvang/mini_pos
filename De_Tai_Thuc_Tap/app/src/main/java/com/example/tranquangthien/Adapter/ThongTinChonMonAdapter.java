...
public class ThongTinChonMonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<MonAn> mMonAn;
    private Context mContext;

    public ThongTinChonMonAdapter(List _MonAn, Context mContext) {
        this.mMonAn = _MonAn;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RecyclerView.ViewHolder viewHolder = new ThongTinChonMonAdapter.ViewHolder(CTMonAn, mMonAn);
        return viewHolder;
    }
    @Override
